...
# A new SignUpForm that inherits from Django's built-in UserCreationForm
class SignUpForm(UserCreationForm):
    # adding an email field
    email = forms.EmailField(
        label="",
        # overriding default widget by using Bootstrap class
    ...
    class Meta:
        # specifying the usermodel
        model = User
        # specifying fields that will be included in the form. These fields are part of the django's User class
